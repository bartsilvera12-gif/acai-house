...
export default function NuevaVentaPage() {
  ...
  async function enviarVenta(permitirSinStock: boolean) {
    ...
    try {
      ...
      // Sin panel post-venta: la comanda/ticket se abre en pestaña nueva (arriba) y
      // la pantalla va directo al listado de ventas. Este cliente no emite recibo de dinero.
      router.push("/ventas");
    } finally {
